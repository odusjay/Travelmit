    ...
    documents: [
      ...
      RequiredDocument(
        ...
        explanation:
            ...
            'holds.',
        warning:
            'Check the guardian\u2019s date of birth carefully, not just '
            'their age on paper. Someone is only as old as their most '
            'recent birthday, even close to the next one \u2014 a guardian '
            'born 1 September 1960 is still 65, not 66, right up until 1 '
            'September 2026. Getting this wrong is one of the costliest '
            'mistakes in the whole process: it means paying the \u20AC400 '
            'lawyer fee again and waiting another 2 to 4 months for '
            'verification.',
      ),
      RequiredDocument(
        id: 'marriage-cert',
    ...
    documents: [
      ...
      RequiredDocument(
        ...
        explanation:
            ...
            'Money that appears without explanation is one of the most '
            'common reasons applications fail. From experience, showing '
            'around \u20A630 million comfortably clears this for a single '
            'applicant \u2014 above the calculated minimum, with room for '
